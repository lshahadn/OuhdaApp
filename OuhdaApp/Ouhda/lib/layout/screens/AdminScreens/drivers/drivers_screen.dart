...
class _DriversScreenState extends State<DriversScreen> {
  ...
  Widget _driverWidget(AdminController adminController) {
    return Column(
      children: [
        Container(
  ...
  // Child information
  Widget driverInfoBuilder(UserModel model, AdminController controller) {
    return Stack(
        ...
        Positioned(
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                  ...
                  onPressed: () {
                    // print(model.id);
                    Get.toNamed(RouteHelper.getUpdateProfileRoute(model));
                  },
